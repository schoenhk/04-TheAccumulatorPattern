...
def draw_parallel_lines(n, point, length, window):
    ...
    for k in range(n):
        line = rg.Line(rg.Point(point.x, point.y + k*5), rg.Point(point.x + length, point.y + k*5))
...
def draw_lines(n, point, window):
    ...
    # ------------------------------------------------------------------
    for k in range(n):
        if n >= 2 and k >= (-100) and k <= 100:
            line = rg.Line(rg.Point(point.x, point.y), rg.Point(point.x + 100, point.y + k*5))
            line.attach_to(window)
            window.render()
# ----------------------------------------------------------------------
